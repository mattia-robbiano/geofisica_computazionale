...
gfortran -Wextra -Wall -Wconversion -fimplicit-none -pedantic -fcheck=all -fbacktrace -c ./RadioSondaggi.f90
...
gfortran -Wextra -Wall -Wconversion -fimplicit-none -pedantic -fcheck=all -fbacktrace ./main.f90 IOSTREAM.o RadioSondaggi.o -o main.exe
